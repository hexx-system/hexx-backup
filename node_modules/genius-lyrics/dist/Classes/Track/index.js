...
var Track = /** @class */ (function () {
    function Track(t, key) {
        ...
        this.url = t.url;
        this.artist = t.primary_artist ? new Artist_1.default(t.primary_artist, key) : null;
    ...
    Track.prototype.lyrics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        if (_this.url == null)
                            reject('(GeniusLyrics) No Track URL.');
                        axios_1.default.get(_this.url)
                            .then(function (res) {
                            var $ = cheerio_1.load(res.data);
                            var lyrics = $('.lyrics');
                            if (!lyrics)
                                reject('(GeniusLyrics) No Lyrics was found.');
