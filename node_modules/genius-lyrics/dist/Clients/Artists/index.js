...
var index_1 = require("../../Classes/Artist/index");
var ArtistClient = /** @class */ (function () {
    function ArtistClient(key) {
        if (!key)
            throw new Error('(GeniusLyrics) No Genius Client was Found!');
        this.key = key;
    }
    ArtistClient.prototype.get = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        axios_1.default.get("https://api.genius.com/artists/" + q, {
                            headers: {
                            ...
                            var artist = new index_1.default(res.data.response.artist, _this.key);
                            resolve(artist);
                        })
                            .catch(function (e) {
